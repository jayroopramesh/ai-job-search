...
## Scoreboard
- Sessions completed: **0 / 84** sprint windows (3/day × 28) · missed: 0
- Retention (7-day rolling pass rate): — (no data yet)
- Ledger items: 0 · due today: 0
- 🚩 Flag points — open: 0 · cleared: 0
...
|---|---|---|---|---|---|---|---|
| – | *none yet — Day 1 baseline will seed this table* | | | | | | |
