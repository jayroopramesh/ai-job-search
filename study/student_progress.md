...
| 2026-09-19 | W1 | D3 morning review — 10 items due, first test of symbolic mechanism teaching | 5 posted | in progress | Drive sync clean (44 files, no change). Saturday: W3 is **Mock #1**. Teach-back from D2 still standing. |
