...
```bash
cd study && python3 .learning/scripts/generate_exam_pdf.py exam/exam-<topic-slug>-<timestamp>.md
cd study && python3 .learning/scripts/generate_exam_pdf.py exam/exam-<topic-slug>-<timestamp>-ANSWERS.md
```
